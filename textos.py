...
PADRAO = {
    ...
    "ccusto_paragrafos": "\n\n".join([
        ...
        "Em caso de extravio ou dano a bem sob minha responsabilidade, decorrente de dolo ou culpa, comprometo-me a ressarcir o {orgao_sigla} do prejuízo apurado em procedimento próprio, assegurados o contraditório e a ampla defesa, após deliberação da CAM-GAFI e homologação pelo Plenário do {orgao_sigla}, conforme o Manual de Gestão Patrimonial do {orgao_sigla}, o item 10 da IN SEDAP n.º 205/1988 e os arts. 186 e 927 do Código Civil.",
        "Observações:",
